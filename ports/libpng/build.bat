...
if exist "%PREFIX%\lib\png!PNG_MAJOR_MINOR!.lib" del /q "%PREFIX%\lib\png!PNG_MAJOR_MINOR!.lib"
mklink "%PREFIX%\lib\png!PNG_MAJOR_MINOR!.lib" "%PREFIX%\lib\libpng!PNG_MAJOR_MINOR!.lib"
if exist "%PREFIX%\lib\libpng.lib" del /q "%PREFIX%\lib\libpng.lib"
