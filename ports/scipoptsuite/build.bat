...
if not defined WINFLEXBISON_PREFIX set WINFLEXBISON_PREFIX=%_PREFIX%
...
cmake -G "Ninja"                                                               ^
  ...
  -DBISON_EXECUTABLE="!WINFLEXBISON_PREFIX!\bin\win_bison.exe"                 ^
  -DFLEX_EXECUTABLE="!WINFLEXBISON_PREFIX!\bin\win_flex.exe"                   ^
  .. || exit 1
exit /b 0
