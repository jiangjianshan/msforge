    ...
    def _display_examples_table():
        ...
        try:
            ...
            example_rows = [
                ...
                ("mpt --arch x86 --uninstall gmp fftw", "🗑️ Uninstall specific libraries for x86 architecture"),
            ...
            tip_rows = [
                ...
                ("🎯 Native-Compilation", "Use --arch to specify target architecture (e.g., x64, x86)"),
            ]
