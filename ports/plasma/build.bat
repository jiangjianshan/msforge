...
set C_OPTS=-diagnostics:column -MD -nologo -Qopenmp -Qopenmp-simd -W0 -Xclang -O2 -fms-extensions -fms-hotpatch -fms-compatibility -fms-compatibility-version=%MSC_VER%
set C_DEFS=-DWIN32 -D_WIN32_WINNT=_WIN32_WINNT_WIN10 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -D_USE_MATH_DEFINES -DNOMINMAX -DBLAS_FORTRAN_ADD_
...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i plasma.pc
popd
exit /b 0
