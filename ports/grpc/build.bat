...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i gpr.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i grpc.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i grpc_unsecure.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i grpc++.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i grpc++_unsecure.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i grpcpp_otel_plugin.pc
popd
exit /b 0
