...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i gmock.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i gmock_main.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i gtest.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i gtest_main.pc
popd
exit /b 0
