...
set C_OPTS=-nologo -diagnostics:column -experimental:c11atomics -GF -Gm- -GS -Gw -Gy -openmp:llvm -utf-8
set C_DEFS=-DWIN32 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -D_USE_MATH_DEFINES -DNOMINMAX
