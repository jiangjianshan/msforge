...
xcopy /Y /F /I %BUILD_DIR%\v143\%ARCH%\Release\dll\*.lib "%PREFIX%\lib"
xcopy /Y /F /I %BUILD_DIR%\v143\%ARCH%\Release\dll\*.dll "%PREFIX%\bin"
xcopy /Y /F /I %BUILD_DIR%\v143\%ARCH%\Release\*.exe "%PREFIX%\bin"
xcopy /Y /F /I %SRC_DIR%\libusb\libusb.h "%PREFIX%\include"
xcopy /Y /F /I %SRC_DIR%\libusb\libusbi.h "%PREFIX%\include"
exit /b 0
