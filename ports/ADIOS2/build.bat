...
set C_DEFS=-DWIN32 -D_WIN32_WINNT=_WIN32_WINNT_WIN10 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -D_USE_MATH_DEFINES -D_TIMEVAL_DEFINED
...
cmake -G "Ninja"                                                               ^
  ...
  -DCMAKE_CXX_FLAGS="-permissive- -EHsc %C_OPTS% %C_DEFS%"                     ^
  -DCMAKE_Fortran_COMPILER=ifort                                               ^
  -DCMAKE_Fortran_FLAGS="%F_OPTS%"                                             ^
  -DCMAKE_INSTALL_PREFIX="%PREFIX%"                                            ^
  -DCMAKE_EXE_LINKER_FLAGS="pcrt.lib Shell32.lib"                              ^
  -DCMAKE_SHARED_LINKER_FLAGS="pcrt.lib Shell32.lib"                           ^
  .. || exit 1
exit /b 0
