...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre2-posix.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre2-8.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre2-16.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre2-32.pc
popd
exit /b 0
