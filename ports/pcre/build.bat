...
cmake -G "Ninja"                                                               ^
  ...
  -DCMAKE_CXX_STANDARD_LIBRARIES="pcrt.lib"                                    ^
...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre16.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcre32.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcrecpp.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i libpcreposix.pc
popd
exit /b 0
