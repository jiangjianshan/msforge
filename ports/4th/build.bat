...
cd "%BUILD_DIR%"
if "%ARCH%"=="x64" cl %C_OPTS% %C_DEFS% -Iinclude64 -c *.c || exit 1
if "%ARCH%"=="x86" cl %C_OPTS% %C_DEFS% -Iinclude32 -c *.c || exit 1
ren 4th.obj 4th.o
ren 4tsh.obj 4tsh.o
ren pp4th.obj pp4th.o
ren ubasic64.obj ubasic64.o
lib /OUT:lib4th.lib *.obj || exit 1
link /OUT:4th.exe 4th.o lib4th.lib || exit 1
link /OUT:4tsh.exe 4tsh.o lib4th.lib || exit 1
link /OUT:pp4th.exe pp4th.o lib4th.lib || exit 1
exit /b 0
