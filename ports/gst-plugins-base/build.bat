...
meson setup "%BUILD_DIR%"                                                      ^
  ...
  -Dc_winlibs="iconv.lib,pcrt.lib,Advapi32.lib,User32.lib"                     ^
  -Dcpp_winlibs="iconv.lib,pcrt.lib,Advapi32.lib,User32.lib"                   ^
  -Dexamples=disabled                                                          ^
...
pushd "%PREFIX%\lib\gstreamer-1.0\pkgconfig"
for %%f in ("gstcore*.pc") do (
